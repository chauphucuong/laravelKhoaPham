...
// dùng tron Kp-new chỉ có in hoa chữ cái đầu tiền của vd Xa Hoi và không dấu
...
// select = 6 sẽ hiển thị ra dòng có id là 6
function cate_parent($data , $parent = 0,$str = "",$select = 6){
	foreach($data as $val){
		$id = $val["id"];
		$name = $val["name"];
